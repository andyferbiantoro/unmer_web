...
<head>
  ...
  <title>Masukkan NID NUMBER</title>
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-primary">
              <div class="card-header"><h4>Masukkan NID</h4></div>

              <div class="card-body">
                <form action="{{route('proses_cek_nid')}}" method="post">
                  {{csrf_field()}}

                  <input type="text" class="form-control" tabindex="1" required="" name="nid_unmer" placeholder="NID NUMBER"><br>
