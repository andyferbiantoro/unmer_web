...
<div class="row">
 <div class="col-lg-12">
  <div class="card">
                ...
                <div class="card-body">
                  <h2 class="primary">User Customer </h2><hr>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="#" data-toggle="modal" onclick="deleteData({{$data->id}})" data-target="#DeleteModal">
                              <button class="btn btn-warning btn-sm"  title="jadikan Partner"> <i class="fas fa-check"></i> Jadikan Partner</button>
                            @else
                              <div class="badge badge-success"><i class="fas fa-handshake"></i> Partner</div>
                            @endif
                          </td>
