  ...
  <div class="card">
                ...
                <div class="card-body">
                 ...
                 <a href="{{ route('superadmin_kelola_admin') }}"><button type="button" class="btn btn-primary btn-sm">Tabel Admin Penginapan</button></a>
                  <a href="{{ route('superadmin_admin_kasir') }}"><button type="button" class="btn btn-warning btn-sm">Tabel Admin Kasir</button></a>
                ...
                <div class="modal-body">
                 <form method="post" action="{{route('admin_add')}}" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    <input type="text" class="form-control" id="role_admin" name="role_admin"  required="" value="Admin Kasir"></input>
                  </div>
