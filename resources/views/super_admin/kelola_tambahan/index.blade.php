        ...
        <table id="dataTable" class="table table-striped" style="width:100%">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                @if($data->status == 'aktif')
                <a href="#" data-toggle="modal" onclick="nonaktifkan({{$data->id}})" data-target="#NonAktifkanModal"><button class="btn btn-danger btn-sm"  title="Non Aktifkan Menu"><i class="fas fa-lock"></i></button>

                @elseif($data->status == 'nonaktif')
                <a href="#" data-toggle="modal" onclick="aktifkan({{$data->id}})" data-target="#AktifkanModal"><button class="btn btn-success btn-sm"  title="Aktifkan Kembali Menu"><i class="fas fa-lock-open"></i></button>
                @endif
              </td>
