          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <a href="{{route('admin_foto_event_delete',$data->id)}}"><button class="btn btn-danger btn-sm"><i class="fas fa-trash"></i> Hapus</button></a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form method="post" action="{{route('admin_foto_event_add')}}" enctype="multipart/form-data">
