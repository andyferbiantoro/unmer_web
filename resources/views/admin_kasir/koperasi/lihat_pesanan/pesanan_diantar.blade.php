...
<div class="row">
 <div class="col-lg-12">
  <div class="card">
    ...
    <div class="card-body">
      <h2 class="primary">Transaksi Koperasi Diantar</h2>
      <hr>
      <a href="{{ route('admin_kasir_lihat_pesanan_koperasi_diantar') }}"><button type="button" class="btn btn-primary btn-sm"><i class="fas fa-motorcycle"></i> Pesanan Diantar</button></a>
